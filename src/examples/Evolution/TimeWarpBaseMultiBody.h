...
static btScalar gSimulationSpeed = 2; // default simulation speed at startup
 ...
 */
struct TimeWarpBaseMultiBody : public CommonMultiBodyBase {

	TimeWarpBaseMultiBody(struct GUIHelperInterface* helper) :
